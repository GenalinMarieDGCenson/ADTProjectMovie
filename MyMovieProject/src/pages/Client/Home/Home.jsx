...
function Home() {
    ...
    axios.get('/movies', {
      ...
      .then((response) => {
        ...
        const featuredMovies = movies.filter((movie) =>
          movie.isFeatured === true || movie.isFeatured === 'true'
        );
  ...
  useEffect(() => {
    ...
    const intervalId = setInterval(() => {
      const featuredMovies = lists.filter((movie) =>
        movie.isFeatured === true || movie.isFeatured === 'true'
      );
    ...
    <div className="main-container">
      ...
      {featuredMovie ? (
        <div className="featured-list-container">
          ...
          >
            <h1 className="title-movies-h1-2">{featuredMovie.title}</h1>
            <div className="Movies-Title-Description">
              <div className="PostPath-Img">
                <img
                  className="img-postpath-auto"
              ...
              <div className="Title-Description-Box">
                <h1 className="title-movies-h1">{featuredMovie.title}</h1>
                <hr />
                <p className="overview-movies-p">{featuredMovie.overview}</p>
              </div>
            </div>
          </div>
        </div>
